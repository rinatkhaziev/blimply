 ...
 */
add_action( 'admin_menu', 'blimply_add_menu' );
add_action( 'admin_init', 'blimply_register_settings' );
 ...
 */
function blimply_create_settings_field( $args = array() ) {
	...
	$defaults = array(
		...
		'section' => 'main_section', 					// the section this setting belongs to  must match the array key of a section in blimply_options_page_sections()
	...
	// additional arguments for use in form field output in the function blimply_form_field_fn!
	$field_args = array(
		'type'      => $type,
		'id'        => $id,
		'desc'      => $desc,
	...
	add_settings_field( $id, $title, 'blimply_form_field_fn', __FILE__, $section, $field_args );
 ...
 */
function blimply_register_settings(){
 ...
 * @return echoes output
 */
function blimply_settings_page_fn() {
	// get the settings sections array
	$settings_output = blimply_get_settings();
?>
	<div class="wrap">
		<div class="icon32" id="icon-options-general"></div>
		<h2><?php echo $settings_output['blimply_page_title']; ?></h2>
